    ...
    <footer className="bg-slate-800 dark:bg-slate-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 gradient-text">Tamara Elyyan</h3>
            <p className="text-slate-400 mb-4">
              Full Stack Developer & Network Engineer passionate about creating innovative solutions.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="mailto:TamaraElyyan1@gmail.com" className="text-slate-400 hover:text-white transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-slate-400">Network Engineering</li>
              <li className="text-slate-400">Cloud Solutions</li>
        ...
        <div className="border-t border-slate-700 mt-8 pt-8 text-center">
          <p className="text-slate-400">
            © 2024 Tamara Elyyan. All rights reserved. Built with ❤️ using React.js & Tailwind CSS
          </p>
        </div>
      </div>
    </footer>
